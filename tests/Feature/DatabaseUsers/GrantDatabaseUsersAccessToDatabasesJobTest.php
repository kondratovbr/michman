...
use App\Scripts\Root\Mysql8_0\GrantDatabaseUserAccessToDatabaseScript;
...
class GrantDatabaseUsersAccessToDatabasesJobTest extends AbstractFeatureTest
{
    ...
    public function test_job_parameters_and_logic()
    {
        ...
        $job = new GrantDatabaseUsersAccessToDatabasesJob($databaseUsers, $databases);
        ...
        $this->mock(
            GrantDatabaseUserAccessToDatabaseScript::class,
