 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \App\Support\Translator $instance */
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \App\Support\Translator::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \App\Support\Translator::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Translation\Translator         
                        return \App\Support\Translator::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {            //Method inherited from \Illuminate\Translation\Translator         
                        \App\Support\Translator::flushMacros();
        }
...
')
     ...
     */ 
         ...
         *
         * @see \App\Providers\GuzzleServiceProvider::boot()
         * @return array|null 
         * @static 
         */ 
        public static function links()
        {
                        return \Illuminate\Http\Client\Response::links();
        }
                    /**
        ...
        {
                        return \Illuminate\Http\Client\Response::nextUrl();
        }
...
namespace  { 
            ...
            class Arr extends \App\Support\Arr {}
            ...
            class Str extends \App\Support\Str {}
            class URL extends \Illuminate\Support\Facades\URL {}
            class Validator extends \Illuminate\Support\Facades\Validator {}
            class View extends \Illuminate\Support\Facades\View {}
            class Vite extends \Illuminate\Support\Facades\Vite {}
            class Agent extends \Jenssegers\Agent\Facades\Agent {}
            class Rgb extends \BaconQrCode\Renderer\Color\Rgb {}
